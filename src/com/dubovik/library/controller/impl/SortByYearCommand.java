...
public class SortByYearCommand implements ActionCommand {

    public Map<String, String> execute(Map<String, String> command_parameters) {
        Map<String, String> result = new HashMap<>();
        try {
            List<CustomBook> sorted_books = BookService.getInstance().sortByYear();
            int index_of_book = 1;
            ...
            result.put("status", "Error while sorting books by year");
        }
        return result;
    }
}
